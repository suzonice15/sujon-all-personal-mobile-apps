...
const styles = (colors) => StyleSheet.create({
  ...
  codeCard: { backgroundColor: colors.surface, marginHorizontal: 10, marginTop: 12, borderRadius: 14, padding: 14, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 3 },
  ...
  menuItem: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: colors.surface, marginHorizontal: 10, marginBottom: 6, borderRadius: 12, padding: 14, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 3 },
